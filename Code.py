            ...
            for x in range(n // 2):
                for y in range(n // 2):
                    if (x == 0 or y == x or y == n // 2 - x - 1) and x > n // 4 - 1:
                        matrix[x - n // 4 + n // 8 + 1][y + 1] = symb
            for x in range(n // 2):
                for y in range(n // 2):
                    if (x == 0 or y == x or y == n // 2 - x - 1) and x > n // 4 - 1:
                        matrix[x - n // 4 + n // 8 + 1][y + n // 2] = symb
            for x in range(n):
                for y in range(n):
                    if (y == x or y == n - x - 1) and x < n // 2 + 1:
                ...
                if row_counter == n // 2:
                    for y in range(n):
                        if (y == 1 or y == n - 1):
                            ...
                            matrix[row_counter][1] = "`"
                            matrix[row_counter][2] = "И"
                            matrix[row_counter][3] = "в"
                            matrix[row_counter][4] = "а"
                            matrix[row_counter][5] = "н"
                            matrix[row_counter][6] = "_"
                            matrix[row_counter][7] = "Н"
                            matrix[row_counter][8] = "и"
                            matrix[row_counter][9] = "к"
                            matrix[row_counter][10] = "о"
                            matrix[row_counter][11] = "л"
                            matrix[row_counter][12] = "а"
                            matrix[row_counter][13] = "е"
                            matrix[row_counter][14] = "в"
                            matrix[row_counter][15] = "и"
                            matrix[row_counter][16] = "ч"
                for element in row:
                    element_counter += 1
                    Name = "Иван_Николаевич"
                    if Name.find(element) == -1 and element != '`' and element != '_':
                        print(element, end='  ')
                    elif element == '`':
